...
baggingMlp = BaggingClassifier(mlp, oob_score=True, max_samples=0.8, n_estimators=30, random_state=seed)
...
title = "30_estimators"
plot_learning_curve(baggingMlp, title, X_train, Y_train, (0.7, 1.01), cv=kfold, n_jobs=4)
plt.show()
